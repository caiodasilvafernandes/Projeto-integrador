...
INSERT INTO `pais` (`idPais`, `nome`, `nome_pt`, `sigla`, `bacen`) VALUES
...
--
ALTER TABLE `avaliacao`
  ADD CONSTRAINT `idFkPacote` FOREIGN KEY (`idPacote`) REFERENCES `pacote` (`idPacote`) ON DELETE CASCADE;

--
-- Limitadores para a tabela `comentario`
--
ALTER TABLE `comentario`
  ADD CONSTRAINT `idFPacote` FOREIGN KEY (`idPacote`) REFERENCES `pacote` (`idPacote`) ON DELETE CASCADE;
...
--
ALTER TABLE `pacotesfav_comp`
  ADD CONSTRAINT `idCliente` FOREIGN KEY (`idFkCliente`) REFERENCES `cliente` (`idCliente`) ON DELETE CASCADE,
  ADD CONSTRAINT `idPacote` FOREIGN KEY (`idFkPacote`) REFERENCES `pacote` (`idPacote`) ON DELETE CASCADE;
COMMIT;
